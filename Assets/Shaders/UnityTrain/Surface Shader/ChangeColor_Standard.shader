...
Shader "UnityTrain/Surface/ChangeColor_Standard" {
    Properties {
        _FirstColor ("FirstColor", COLOR) = (1, 1, 1, 1)
        _SecondColor ("SecondColor", COLOR) = (1, 1, 1, 1)
        _SplitPosition ("SplitPosition", Range(-3, 3)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(v2f i) : SV_Target {
                float blendPos = i.z - _SplitPosition;
                float blendScale = blendPos / _Radius;
                float blendLerpValue = blendScale / 2 + 0.5f;
                //return lerp(_FirstColor, _SecondColor, blendLerpValue);
