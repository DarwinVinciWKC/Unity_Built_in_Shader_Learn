Shader "Unity Shader Book/Chapter 6/Specular Vertex Level-Blinn-Phong" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            v2f vert(a2v v) {
                ...
                fixed3 specular = _LightColor0.xyz * _Specular * pow(saturate(dot(worldNormal, halfDir)), _Gloss);
